...
export function GetAiAssistantSession() {
  return window['go']['main']['App']['GetAiAssistantSession']();
}
...
export function SaveAiAssistantSession(arg1) {
  return window['go']['main']['App']['SaveAiAssistantSession'](arg1);
}
