...
interface SidebarProps {
  /** 来自后端的配置（Wails 下由 useAppData 注入），用于控制菜单显隐等 */
  config?: { enableFund?: boolean; enableAgent?: boolean } | null;
  /** 自选分组列表（Wails 下由 useAppData 注入） */
  groupList?: Array<{ ID?: number; name?: string }>;
}

export function Sidebar({ config, groupList = [] }: SidebarProps) {
