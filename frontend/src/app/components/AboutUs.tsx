...
export function AboutUs() {
  ...
  return (
    <div className="space-y-6">
      {/* 头部 */}
      <div className="bg-card rounded-xl border border-border p-4 sm:p-6 shadow-2xl">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h2 className="text-xl text-foreground font-light">关于我们</h2>
            <p className="text-xs text-muted-foreground">About Us · Financial Dashboard</p>
          </div>
        </div>
      ...
      >
        <div className="bg-card rounded-xl border border-border p-4 shadow-2xl hover:border-cyan-500/30 transition-all group">
          ...
          <h3 className="text-base text-foreground font-medium mb-2">实时数据</h3>
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-2xl hover:border-cyan-500/30 transition-all group">
          ...
          <h3 className="text-base text-foreground font-medium mb-2">智能分析</h3>
          <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-2xl hover:border-cyan-500/30 transition-all group">
          ...
          <h3 className="text-base text-foreground font-medium mb-2">数据安全</h3>
          <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-2xl hover:border-cyan-500/30 transition-all group">
          ...
          <h3 className="text-base text-foreground font-medium mb-2">多维度分析</h3>
          <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-2xl hover:border-cyan-500/30 transition-all group">
          ...
          <h3 className="text-base text-foreground font-medium mb-2">用户至上</h3>
          <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-2xl hover:border-cyan-500/30 transition-all group">
          ...
          <h3 className="text-base text-foreground font-medium mb-2">专业资讯</h3>
          <p className="text-xs text-muted-foreground leading-relaxed">
      ...
      {/* 数据统计 */}
      <div className="bg-card rounded-xl border border-border p-4 sm:p-6 shadow-2xl">
        <h3 className="text-lg text-foreground font-light mb-4">平台数据</h3>
        <div
          className={cn(
            "grid gap-4",
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-muted-foreground">覆盖股票</div>
          </div>
          <div className="text-center">
            <div className="text-2xl sm:text-3xl font-light text-green-400 mb-1">10M+</div>
            <div className="text-xs text-muted-foreground">日均数据量</div>
          </div>
          <div className="text-center">
      ...
      {/* 技术栈 */}
      <div className="bg-card rounded-xl border border-border p-4 sm:p-6 shadow-2xl">
        <h3 className="text-lg text-foreground font-light mb-4">技术架构</h3>
        <div
          className={cn(
            "grid gap-3",
            compactLayout ? "grid-cols-2 md:grid-cols-4" : "grid-cols-4",
      ...
      {/* 联系方式 */}
      <div className="bg-card rounded-xl border border-border p-4 sm:p-6 shadow-2xl">
        <h3 className="text-lg text-foreground font-light mb-4">联系我们</h3>
        <div
          className={cn(
            "grid gap-4",
            compactLayout ? "grid-cols-1 md:grid-cols-3" : "grid-cols-3",
        ...
        >
          <button className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-lg border border-white/10 hover:border-cyan-500/30 transition-all group">
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-foreground">contact@finboard.com</div>
            </div>
          </button>
          ...
          <button className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-lg border border-white/10 hover:border-purple-500/30 transition-all group">
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-foreground">github.com/finboard</div>
            </div>
          </button>
          ...
          <button className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-lg border border-white/10 hover:border-blue-500/30 transition-all group">
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-foreground">@FinBoard</div>
            </div>
          </button>
        </div>
      </div>
